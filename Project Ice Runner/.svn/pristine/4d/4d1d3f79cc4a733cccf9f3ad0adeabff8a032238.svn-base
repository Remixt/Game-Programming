...
bool DisplayManager::Init()
{
    ...
    pWindow_ = SDL_CreateWindow(options_.pTitle, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, (int)options_.screenWidth, (int)options_.screenHeight, SDL_WINDOW_HIDDEN | SDL_WINDOW_RESIZABLE);
