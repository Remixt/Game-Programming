...
bool ResourceManager::LoadSound()
{
    ...
    soundEffects_[(size_t)SoundEffect::Bump] = loader.CreateEffect("res/sound/effects/bump.ogg");
    soundEffects_[(size_t)SoundEffect::Goal] = loader.CreateEffect("res/sound/effects/goal.ogg");
    soundEffects_[(size_t)SoundEffect::MenuCycle] = loader.CreateEffect("res/sound/effects/menu_cycle.ogg");
    soundEffects_[(size_t)SoundEffect::MenuSelect] = loader.CreateEffect("res/sound/effects/menu_select.ogg");
