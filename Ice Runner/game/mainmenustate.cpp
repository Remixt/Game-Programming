...
MainMenuState::MainMenuState(types::GameSystems& gameSystems)
    : GameState(gameSystems), resourceManager_(ResourceManager::GetInstance(gameSystems)),
      ...
      pNextState_(nullptr),
      pCycleEffect_(resourceManager_.GetSoundEffect(ResourceManager::SoundEffect::MenuCycle)),
      pSelectEffect_(resourceManager_.GetSoundEffect(ResourceManager::SoundEffect::MenuSelect)),
