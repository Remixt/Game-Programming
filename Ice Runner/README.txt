...
MAP COLOR LEGEND:
	...
	White = Empty Space
*****
Note: Currently if you want to change the color of the map you can. To do so you can modify the config file found in exe/res/scripts/config.lua
The colors are RGB converted into floating point. (Find an RGB value and divide each value by 255)

I plan on allowing color changes in a later build of the map maker.
